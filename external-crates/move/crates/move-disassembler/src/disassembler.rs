...
impl<'a> Disassembler<'a> {
    ...
    fn name_for_field(&self, field_idx: FieldHandleIndex) -> Result<String> {
        ...
        let struct_handle = self
            .source_mapper
            .bytecode
            .data_type_handle_at(struct_def.struct_handle);
    ...
    fn struct_type_info(
        ...
        let struct_handle = self
            .source_mapper
            .bytecode
            .data_type_handle_at(struct_definition.struct_handle);
        let name = self
            .source_mapper
            .bytecode
            .identifier_at(struct_handle.name)
        ...
        Ok(match sig_tok {
            ...
            SignatureToken::DataType(struct_handle_idx) => self
                ...
                .identifier_at(
                    self.source_mapper
                        .bytecode
                        .data_type_handle_at(struct_handle_idx)
                        .name,
                )
                .to_string(),
    ...
    fn disassemble_jump_tables(&self, code: &CodeUnit) -> Result<Vec<String>> {
        ...
        for (i, jt) in code.jump_tables.iter().enumerate() {
            ...
            let enum_handle = self
                .source_mapper
                .bytecode
                .data_type_handle_at(enum_def.enum_handle);
    ...
    fn disassemble_data_type_type_formals(
    ...
    pub fn disassemble_struct_def(&self, struct_def_idx: StructDefinitionIndex) -> Result<String> {
        ...
        let ty_params = Self::disassemble_data_type_type_formals(
    ...
    pub fn disassemble_enum_def(&self, enum_def_idx: EnumDefinitionIndex) -> Result<String> {
        ...
        let enum_handle = self
            .source_mapper
            .bytecode
            .data_type_handle_at(enum_definition.enum_handle);
        let enum_source_map = self
            .source_mapper
            .source_map
